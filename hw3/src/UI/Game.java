...
public class Game implements Observable, MessageHandler {
    ...
    //  prints the player menu on the screen
    //  the choice is passed through an observer interface on to the business logic to create the player
    public void choosePlayer() {
        ...
        System.out.println("7. Ygritte                Health: 220/220           Attack: 30              Defense: 2              Level: 1          Experience: 0/50                Arrows: 10              Range: 6");
    ...
    public static void main (String args[]){
        Game game = new Game();
        game.addObserver(new GameFlow());       // adds an observer
